...
def post_up_message
  ...
  msg << "\n* SSH into the machine then navigate to your site at `/srv/www`"
  msg << "\n* Execute bundle install in your app directory on the VM box"
  msg << "\n* NOTE: database setup and migrations must be run on the VM box"

  # msg << "\n* You must SSH into the machine to run database setup and migrations"
